...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, h, d) { b != Array.prototype && b != Object.prototype && (b[h] = d.value) };
...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, p) {
        d = null != d ? d : function(b) { return b };
        var h = [],
            n = "undefined" != typeof Symbol && Symbol.iterator && b[Symbol.iterator];
        if ("function" == typeof n) { b = n.call(b); for (var r = 0; !(n = b.next()).done;) h.push(d.call(p, n.value, r++)) } else
            for (n = b.length, r = 0; r < n; r++) h.push(d.call(p, b[r], r));
        return h
    }
}, "es6", "es3");
$jscomp.owns = function(b, h) { return Object.prototype.hasOwnProperty.call(b, h) };
...
$jscomp.findInternal = function(b, h, d) { b instanceof String && (b = String(b)); for (var p = b.length, l = 0; l < p; l++) { var n = b[l]; if (h.call(d, n, l, b)) return { i: l, v: n } } return { i: -1, v: void 0 } };
...
$jscomp.polyfill("Array.prototype.includes", function(b) {
    return b ? b : function(b, d) {
        ...
        var l = h.length;
        d = d || 0;
        for (0 > d && (d = Math.max(d + l, 0)); d < l; d++) { var n = h[d]; if (n === b || Object.is(n, b)) return !0 }
        return !1
    }
}, "es7", "es3");
...
(function() {
    function b(a, f) {
        var b = Array.from(a.querySelectorAll(f));
        a.matches && a.matches(f) && b.splice(0, 0, a);
        return b
    }

    function h(a) { a = a.getBoundingClientRect(); return { top: a.top + document.body.scrollTop, left: a.left + document.body.scrollLeft } }

    function d(a) { return parseFloat(getComputedStyle(a, null).height.replace("px", "")) }

    function p(a) { return parseFloat(getComputedStyle(a, null).width.replace("px", "")) }

    function l(a) { "loading" != document.readyState ? a() : document.addEventListener("DOMContentLoaded", a) }
    ...
    function r(a) {
        ...
        (function c() {
            ...
            1 < (b += .1) || (a.style.opacity = b, requestAnimationFrame(c))
        })()
    }

    function w(a) {
        var b = [],
            c = { blackberry: "BlackBerry", android: "Android", windows: "IEMobile", opera: "Opera Mini", ios: "iPhone|iPad|iPod" };
        a = "undefined" == typeof a ? "*" : a.toLowerCase();
        "*" === a ? b = Object.values(c) : a in c && b.push(c[a]);
    ...
    function z(a) {
        ...
        a.querySelectorAll(".carousel").forEach(function(a) { a.setAttribute("id", b) });
        ...
        a.querySelectorAll(".carousel-indicators > li").forEach(function(a) { c ? a.setAttribute("data-bs-target", "#" + b) : a.setAttribute("data-target", "#" + b) });
        C(a)
    }

    function D(a) {
        var b = a.querySelectorAll(".carousel-item").length,
            c = a.querySelector(".carousel-inner").getAttribute("data-visible");
        b < c && (c = b);
        a.querySelectorAll(".carousel-inner").forEach(function(a) { a.setAttribute("class", "carousel-inner slides" + c) });
        a.querySelectorAll(".clonedCol").forEach(function(a) { a.remove() });
        a.querySelectorAll(".carousel-item .col-md-12").forEach(function(a) { 2 > c ? a.setAttribute("class", "col-md-12") : "5" == c ? a.setAttribute("class", "col-md-12 col-lg-15") : a.setAttribute("class", "col-md-12 col-lg-" + 12 / c) });
        a.querySelectorAll(".carousel-item .row").forEach(function(a) { a.setAttribute("style", "-webkit-flex-grow: 1; flex-grow: 1; margin: 0;") });
        a.querySelectorAll(".carousel-item").forEach(function(a) {
            for (var b = a, f = 1; f < c; f++) {
                ...
                d = b.querySelector(".col-md-12").cloneNode(!0);
    ...
    function E(a) {
        var b = "",
            c = a.querySelector("svg linearGradient");
        if (c) {
            b = [];
            c = Array.from(c.children);
            for (var k = 0; k < c.length; k++) b.push('"' + c[k].getAttribute("stop-color") + '"');
            b = '"lineargradient": [' + b + "],";
            Array.from(a.querySelectorAll("svg")).some(function(a) { return a.classList.contains("svg-gradient") }) ||
    ...
    function x(a, b, c) {
        var f = a.closest(".card"),
            e = f.parentElement.classList;
        f.getAttribute("style") || f.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;");
        e.contains("row") && (e.remove("row"), e.add("media-container-row"));
        a.querySelectorAll(".svg-gradient > *").forEach(function(a) { a.setAttribute("id", b) });
        f = a.cloneNode(!0);
        Array.from(a.children).forEach(function(a) { if ("SVG" !== a.tagName) return a.remove() });
        a.setAttribute("data-pie", "{ " + E(a.closest("section")) + ' "percent": ' + c + ', "size": 150, "colorCircle": "#f1f1f1", "stroke": 5, "colorSlice": "url(#' + b + ')", "fontSize": "1.3rem", "number": false }');
        Array.from(f.children).forEach(function(b) {
            switch (!0) {
                case b.matches("p"):
                    b.innerText = c + "%";
                    a.appendChild(b);
    ...
    Element.prototype.parents =
        function(a) { for (var b = [], c = this, d = void 0 !== a; null !== (c = c.parentElement);) c.nodeType === Node.ELEMENT_NODE && (d && !c.matches(a) || b.push(c)); return b };
    Element.prototype.footerReveal = function() {
        function a() {!c && this.offsetHeight <= window.outerHeight ? (this.style.zIndex = "-999", this.style.position = "fixed", this.style.bottom = "0", this.style.width = b.offsetWidth, b.style.marginBottom = this.offsetHeight) : (this.style.zIndex = "", this.style.position = "", this.style.bottom = "", this.style.width = "", b.style.marginBottom = "") }
        var b =
    ...
    (function(a) {
        var b = function(a, b, e) {
            ...
            return function() {
                var f = this,
                    d = arguments;
                c ? clearTimeout(c) : e && a.apply(f, d);
    ...
    l(function() {
        function a(a) { a.style.height = 9 * p(a.parentNode) / 16 + "px" }
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                        if (c && /youtu\.?be/g.test(c[3])) {
                            ...
                            d.onload = function() {
                                ...
                                var e = d.naturalHeight,
                                    u = d.naturalWidth,
                                    k = d.naturalHeight / d.naturalWidth,
                                    y = b.parentNode.clientHeight,
                                    g = b.parentNode.clientWidth;
                                e = e < y ? e : y;
                                u = u > g ?
                                    u : g;
                                e / u != k && (e = u * k);
                                k = new YouTubePlayer(b, { height: e, width: u, modestbranding: !0, autoplay: !0, controls: !1, origin: "*", iv_load_policy: !1, keyboard: !1, captions: !1, annotations: !1, related: !1 });
                                b.style.pointerEvents = "none";
                                b.style.width = u + "px";
                                b.style.marginTop = "-" + (e - y) / 2 + "px";
                                b.style.marginLeft = "-" + (u - g) / 2 + "px";
                            ...
                            if (c && /vimeo/g.test(c[3])) {
                                ...
                                b = new Vimeo.Player(e, { id: b, loop: !0, background: !0, responsive: !0, autoplay: !0, byline: !1, title: !1, muted: !0 });
        ...
        }(window.innerWidth, window.innerHeight) : G || (window.smartresize(function() { document.querySelector(".mbr-section--full-height").style.height = window.innerHeight + "px" }), g(document).on("add.cards", function(a) { document.querySelector("html").classList.contains("mbr-site-loaded") && b(a.target, ".mbr-section--full-height").length && window.dispatchEvent(new CustomEvent("resize")) }));
        window.addEventListener("smartresize", function() { document.querySelectorAll(".mbr-section--16by9").forEach(a) });
        if (t) g(document).on("add.cards changeParameter.cards",
            function(c) {
            ...
            if (m) {
                ...
                g(document).on("changeParameter.cards", function(a, b, c, e) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", g(a.target).find(".mbr-background-video-preview").remove(), g(a.target).find(".mbr-background-video").remove(), e) {
                        case "type":
                            !0 === c.parallax && f(a.target);
                            break;
                        case "value":
                            "image" === c.type && !0 === c.parallax && f(a.target);
                            break;
                        case "parallax":
                            !0 === c.parallax && f(a.target)
                    }
        ...
        if (t) g(document).on("add.cards delete.cards",
            function(a) {
                k && clearTimeout(k);
                k = setTimeout(function() {
                    q && (q.fixed = !1, q.elm.classList.remove("is-fixed"));
                    var a = document.querySelector(".mbr-fixed-top");
                    a && (q = { breakPoint: h(a).top + 3 * d(a), fixed: !1, elm: a }, a.dispatchEvent(new CustomEvent("scroll")))
                }, 650)
            });
        window.smartresize(function() { document.querySelectorAll(".mbr-embedded-video").forEach(function(a) { a.style.height = (p(a) * parseInt(a.getAttribute("height") || 315) / parseInt(a.getAttribute("width") || 560)).toFixed() + "px" }) });
        if (t) g(document).on("add.cards",
            function(a) { document.querySelector("html").classList.contains("mbr-site-loaded") && b(a.target, "iframe").length && window.dispatchEvent(new CustomEvent("resize")) });
        if (m) {
            if (!t) return;
            g(document).on("add.cards", function(a) { c(a.target) })
        } else c(document.body);
        if (m) g(document).on("changeParameter.cards", function(a, b, e, f) {
            if ("bg" === b) switch (f) {
                case "type":
                    "video" === e.type && c(a.target);
                    break;
                case "value":
                    "video" === e.type && c(a.target)
            }
        });
        m || Array.from(document.body.children).filter(function(a) { return !a.matches("style, script") }).forEach(function(a) {
        ...
        m || document.addEventListener("click", function(a) {
            try {
                var b = a.target;
                if (!b.parents().some(function(a) { a.classList.contains("carousel") })) {
                    do
                        if (b.hash) {
                            var c = /#bottom|#top/g.test(b.hash);
                            document.querySelector(c ? "body" : b.hash).forEach(function(c) {
                                a.preventDefault();
                                var e = b.parents().some(function(a) { return a.classList.contains("navbar-fixed-top") }) ?
                                    60 : 0;
                                e = "#bottom" == b.hash ? d(c) - window.innerHeight : h(c).top - e;
    ...
    if (!m) {
        ...
        if (t) g(document).on("add.cards", function(a) { a.target.classList.contains("mbr-reveal") && a.target.footerReveal() });
        l(function() {
            if (!w() && document.querySelectorAll("input[name=animation]").length) {
                var a = function() {
                        var a = document.documentElement.scrollTop || document.body.scrollTop,
                            f = a + window.innerHeight - 100;
                        d.forEach(function(e) {
                            var d = e.offsetHeight,
                                k = c(e);
                            (k + d >= a && k - 50 <= f || b(e)) && e.classList.contains("hidden") && (e.classList.remove("hidden"), e.classList.add("animate__fadeInUp"),
                    ...
                    b = function(a) {
                        if (a.parents(".carousel-item").some(function(a) { return "none" !== getComputedStyle(a, null).display })) return !1;
                        ...
                        if (1 <
                            ...
                            if (a.parents().some(function(a) { return a.matches(".cloneditem-" + (c - 1)) }) && a.parents(".cloneditem-" + (c - 1)).some(function(a) { return a.getAttribute("data-cloned-index") >= c })) return !0;
                ...
                document.querySelectorAll("input[name=animation]").forEach(function(a) { a.remove() });
                var d =
                ...
                d = d.filter(function(a) { if (!a.parents().filter(function(a) { if (a.matches("a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop")) return !0 }).length) return !0 });
    ...
    l(function() {
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            ...
            window.addEventListener("scroll", function() { window.scrollY > window.innerHeight ? r(a) : n(a) });
    ...
    l(function() {
        if (!m) {
            var a = function(a) { b(a.target) },
                b = function(b) {
                    var c = b.parents("section")[0].querySelector("iframe"),
                        d = c.getAttribute("src");
                    b.parents("section").forEach(function(a) { a.style.zIndex = "5000" }); - 1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*");
    ...
    if (!m && !w() && (v = document.querySelector("section.menu"))) {
        ...
        !v.querySelector(".navbar").classList.contains("collapsed") && 991 < H && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
            ...
            a.addEventListener("mouseover", function() { a.classList.contains("open") && a.querySelectorAll.forEach(function(a) { a.dispatchEvent(new CustomEvent("click")) }) });
    ...
    m || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) { a.getAttribute("data-isinit") || (z(a), D(a)) })), "undefined" === typeof window.initPopupBtnPlugin && 0 != document.body.querySelectorAll("section.popup-btn-cards").length && (window.initPopupBtnPlugin = !0, document.querySelectorAll("section.popup-btn-cards .card-wrapper").forEach(function(a) { a.classList.add("popup-btn") })), "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function(a) { z(a) })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, l(function() {
        ...
        a.addEventListener("click", function() {
            var b = a.closest(".accordionStyles").getAttribute("id"),
                c = a.closest(".card").querySelector(".panel-collapse"),
        ...
        var b = a.querySelectorAll(".carousel-control"),
            c = a.querySelectorAll(".carousel-indicators li"),
            d = function(a) {
                a.stopPropagation();
                a.preventDefault()
            };
        a.addEventListener("slide.bs.carousel", function() {
            b.forEach(function(a) { a.addEventListener("click", d) });
        ...
        a.addEventListener("slid.bs.carousel", function() {
            b.forEach(function(a) { a.removeEventListener("click", d) });
            c.forEach(function(a) { a.removeEventListener("click", d) });
    ...
    document.querySelectorAll('input[type="range"]').forEach(function(a) { a.addEventListener("change", function(a) { a.target.parents(".form-group").forEach(function(b) { b.querySelector(".value").innerHTML = a.target.value }) }) });
    if (m) g(document).on("add.cards changeParameter.cards", function(a, b) {
        ...
        b ? F(a.target, b) : a.target.querySelectorAll(".pie_progress").length && a.target.querySelectorAll(".pie_progress").forEach(function(a) { B(a) })
    });
